...
public class QuestionDao {
	...
	public Question update(Question question) {
		String sql = "UPDATE QUESTIONS SET writer = ?, title = ?, "
				+ "contents = ?, createdDate = ?, countOfAnswer = ? "
				+ "WHERE questionId = ?";
		jdbcTemplate.update(sql, question.getWriter(), question.getTitle(),
				question.getContents(), question.getCreatedDate(),
				question.getCountOfComment(), question.getQuestionId());
