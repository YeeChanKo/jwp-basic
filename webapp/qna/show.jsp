						...
						<div class="article-util">
							<ul class="article-util-list">
								<li><a class="link-modify-article"
									href="/qna/modifyForm?questionId=${question.questionId}">수정</a></li>
								<li>
								...
								<c:forEach items="${answers}" var="answer">
									<article class="article">
										...
										<div class="article-util">
											<ul class="article-util-list">
												<li><a class="link-modify-article"
													href="/api/qna/updateAnswer?answerId=${answer.answerId}">수정</a></li>
												<li>
													<form class="form-delete" action="/api/qna/deleteAnswer"
														method="POST">
														<input type="hidden" name="questionId"
															value="${question.questionId}"> <input
															type="hidden" name="answerId" value="${answer.answerId}">
